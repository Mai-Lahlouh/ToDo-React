...
function App() {
  ...
  const completedList = todos.filter((l)=>{return l.isCompleted});
  const activeList = todos.filter((l)=> {return !l.isCompleted});
    ...
    <div className='container'>
      <div className='card'>
        ...
        <div className='row'>
          ...
          />
          <button id='addBtn' onClick={handleAdd}>+</button>
        </div>
        {/* --- ToDo List --- */}
        <div className='todo-list'>
          ...
          <div className='filter'>
            ...
            <button value="all" type='button' onClick={changeType} className={buttonType === 'all' ? 'active': ""}>All</button>
            <button value="active" type='button' onClick={changeType} className={buttonType === 'active' ? 'active': ""}>Active</button>
            <button value="completed" type='button' onClick={changeType} className={buttonType === 'completed' ? 'active': ""}>Completed</button>
